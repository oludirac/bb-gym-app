  ...
  if (!activeWorkout) {
    return (
      <div className="space-y-6">
        <section className="border-b border-[color:var(--panel-border)] pb-5">
          ...
          <p className="mt-2 text-sm leading-6 text-[color:var(--muted)]">
            Start today&apos;s lift from Today, or log a fresh session.
          </p>
          <div className="mt-5 grid gap-2">
            <Link
              href="/dashboard"
              className="inline-flex min-h-12 items-center justify-center rounded-md bg-[color:var(--accent)] px-4 text-base font-extrabold text-zinc-950"
            >
              Go to Today
            </Link>
            <form action={startBlankWorkout}>
              <FormSubmitButton
                ...
                className="inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-md border border-[color:var(--panel-border)] px-4 text-base font-extrabold"
              >
        ...
        <Link
          href="/workouts"
          className="flex min-h-12 items-center justify-center gap-2 rounded-md border border-[color:var(--panel-border)] px-4 text-sm font-black"
        >
