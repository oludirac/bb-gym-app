    ...
    <article className="app-card-flat p-4">
      ...
      <div className="mt-4 grid gap-2">
        <Link
          ...
          className="flex min-h-11 items-center justify-center rounded-md border border-[color:var(--panel-border)] px-3 text-sm font-black"
        >
          Open
        </Link>
        {!program.is_public ? (
        ...
        <form action={removeProgram}>
          ...
          <FormSubmitButton
            ...
            className="inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-md border border-[color:var(--danger)]/50 px-3 text-sm font-black text-red-200 transition active:scale-[0.98] disabled:cursor-wait disabled:opacity-70"
          >
    ...
    <div className="space-y-6">
      <header className="space-y-2">
        ...
        <p className="text-sm leading-6 text-[color:var(--muted)]">
          Pick something to follow, then Today will tell you what is up.
        </p>
      </header>
      ...
      <div className="grid grid-cols-2 gap-2">
        <Link
          href="/programs/new"
          className="flex min-h-12 items-center justify-center gap-2 rounded-md bg-[color:var(--accent)] px-4 text-sm font-black text-zinc-950"
        >
      ...
      <section className="space-y-3">
        ...
        {ownPrograms.length === 0 ? (
          <div className="app-card-flat p-4">
            <h3 className="text-base font-semibold">No saved splits yet</h3>
            <p className="mt-1 text-sm leading-6 text-[color:var(--muted)]">
              Pick a starter plan or build your own.
            </p>
          </div>
        ) : (
